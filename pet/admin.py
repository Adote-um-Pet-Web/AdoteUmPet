...
class BannerImagensAdmin(admin.ModelAdmin):
    list_display = ('banner_image1_thumbnail', 'banner_image2_thumbnail', 'banner_image3_thumbnail', 'banner_image1_name', 'banner_image2_name', 'banner_image3_name')
...
class PetAdmin(admin.ModelAdmin):
    ...
    list_display = ('name', 'species', 'breed', 'age', 'adopted', 'profile_image_thumbnail')
