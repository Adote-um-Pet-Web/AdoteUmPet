...
class UserAuthViewsTest(TestCase):
    ...
    def test_login_view(self):
        ...
        response = self.client.post(reverse("userauths:sign-in"), {"email": "test@example.com", "password": "testpassword"})
        ...
        response = self.client.post(reverse("userauths:sign-in"), {"email": "test@example.com", "password": "wrongpassword"})
